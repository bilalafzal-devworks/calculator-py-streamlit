...
st.caption("A simple scientific calculator built with Python and Streamlit")
...
st.session_state.expression = st.session_state.expression_input
...
if st.session_state.history:
    ...
    for calculation in reversed(st.session_state.history):
